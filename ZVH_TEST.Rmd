...
Q (l$\cdot$ s $^{-1}$) & `r PR3$Q1` & `r PR3$Q2` & `r PR3$Q3` & Q$_2$/4      \\ \hline
D (cm)                 &            & `r PR3$D2` & 2D$_2$     & `r PR3$D4`   \\ \hline
S (cm$^{2}$)           &            &            &            &              \\ \hline
\end{tabular}
\end{table}
...
pøítok (l$\cdot$ s$^{-1}$)             & `r PR3$v1` &            &  `r I_Qin`   \\ \hline
pøítok (m$^3$)                         & `r PR3$Q1` & `r PR3$Q2` &              \\ \hline
výpar (l$\cdot$ s$^{-1}$)              &            & `r PR3$D2` &              \\ \hline
výpar (m$^3$)                          &            &            &              \\ \hline
výpar (%)                              & `r XI_ET`  & `r XII_ET` &  `r I_ET`    \\ \hline
min. zùst. prùtok (l$\cdot$ s$^{-1}$)  & `r Qmin`   & `r Qmin`   &  `r Qmin`    \\ \hline
\end{tabular}
\end{table}
